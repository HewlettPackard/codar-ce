...
Please do not pull the Codar image directly as it will not stand up the complete Codar product. This Codar CE image has dependency  over other images hosted in “useitwithcsacodar” repository for example PostgreSQL database and HPE Operations Orchestration CE.
...
Follow the instructions given in the “Instructions to launch HPE Codar CE 1.70 “ below in order to smoothly stand up Codar 1.7 product. You can also refer the “docker-compose.yml” file hosted in the “GitHub” to stand up the product. 
