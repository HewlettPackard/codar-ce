...
HPE Codar CE contains components such as **Core Codar** running in a JBoss container, **HPE Operation Orchestration Community Edition (HP OO CE) Central Server** running on a Tomcat server and HPE Codar CE, HPE OO CE and IDM **databases** created using PostgreSQL Server. 
...
#Advantages you get when using HPE Codar CE 1.6
...
#HPE Codar CE version
```
HPE Codar CE 1.60 with Patch 1
```
...
(If you are not creating a folder under /tmp, please make sure there is no docker-compose.yml exists in the directory before you execute the curl command to stand up HPE Codar 1.6 CE"

	•	mkdir /tmp/codar
	•	cd /tmp/codar 
	•	curl -k -L https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/buildEnv-dockercompose.sh | bash /dev/stdin <hostname> <ipaddress>
  ...
  curl -k -L https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/buildEnv-dockercompose.sh | bash /dev/stdin mydockerclient.mydomain.com 10.1.1.12
...
#Documents
1.	[Concepts Guide](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_1.6_ConceptsGuide.pdf)

2.	[Help Guide](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_160_Help.pdf)

3.	[Configuration Guide](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_160_ConfigurationGuide.pdf)

4.	[API Reference Guide](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_160_API_ReferenceGuide.pdf)

5.	[QuickStart Guide](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_1.6_QuickStartGuide.pdf)

6.	[3rd Party License Guide](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_160_OS-3rdPty-License.pdf)
...
• HPSSO/LWSSO is not enabled. Please refer the help guide to configure HPSSO/LWSSO. Please note that, "ipaddress" is used to configure Codar
...
#Known Issues
For product known issues, please refer Codar 1.60 Release Notes [here](https://github.com/HewlettPackard/codar-ce/raw/master/Codar16/Docs/Codar_160_ReleaseNotes.pdf).
